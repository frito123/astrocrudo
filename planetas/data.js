...
const PLANETAS_DATA = {
  ...
  "Marte": {
    ...
    classicalText: "Marte es el señor de la guerra, del hierro, del corte y de la cólera necesaria. Caliente y seco, representa la fuerza que separa, combate, defiende y afirma. Sus domicilios son Aries, donde actúa de manera frontal, rápida e iniciadora, y Escorpio, donde su fuerza se vuelve profunda, resistente, secreta y penetrante. Se exalta en Capricornio, signo en el que la violencia natural de Marte se disciplina, se vuelve estrategia, mando y logro duradero. Marte es la espada: sin él no hay defensa, no hay valor, no hay capacidad de cortar lo corrupto ni de decir no ante lo dañino. Su exilio en Libra muestra la dificultad de la acción directa cuando la fuerza marcial queda sometida al pacto, la complacencia, la duda y el temor al conflicto.",
